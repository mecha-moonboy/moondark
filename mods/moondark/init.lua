...
dofile(moondark_core.path.."/base/api.lua")
dofile(moondark_core.path.."/base/nodes.lua")
dofile(moondark_core.path.."/base/mapgen.lua")
dofile(moondark_core.path.."/base/abms.lua")
dofile(moondark_core.path.."/base/tools.lua")
dofile(moondark_core.path.."/base/craftitems.lua")
dofile(moondark_core.path.."/base/crafting.lua")